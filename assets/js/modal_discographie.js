...
const img1 = document.querySelector(".discocatchAFire img")
const img2 = document.querySelector(".discoburnin img")
const img3 = document.querySelector(".disconattyFread img")
const img4 = document.querySelector(".discorastamanVibration img")
const img5 = document.querySelector(".discoexodus img")
const img6 = document.querySelector(".discokaya img")
const img7 = document.querySelector(".discosurvival img")
const img8 = document.querySelector(".discouprising img")
